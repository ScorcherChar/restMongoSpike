...
public class QAPAJobOffering implements GenericJobOffering{
    ...
    public String toString() {
        return "ClassPojo [skills = " + skills + ", ref_trades_id = " + ref_trades_id + ", phone = " + phone + ", rome_v3 = " + rome_v3 + ", offer_id = " + offer_id + ", ref_position_levels_id = " + ref_position_levels_id + ", publication_start_date = " + publication_start_date + ", lng_ne = " + lng_ne + ", ref_contract_durations_id = " + ref_contract_durations_id + ", posts = " + posts + ", ref_studies_levels_id = " + ref_studies_levels_id + ", timetable = " + timetable + ", first_name = " + first_name + ", ref_sectors_id = " + ref_sectors_id + ", lat_center = " + lat_center + ", lng_center = " + lng_center + ", description = " + description + ", recruiter_administrative_area_level_1 = " + recruiter_administrative_area_level_1 + ", recruiter_id = " + recruiter_id + ", seniority = " + seniority + ", salary_range_end = " + salary_range_end + ", ref_salary_types_id = " + ref_salary_types_id + ", offer_postal_code = " + offer_postal_code + ", ref_company_sizes_id = " + ref_company_sizes_id + ", lng_sw = " + lng_sw + ", contract_types = " + contract_types + ", offer_locality = " + offer_locality + ", contract_start_date = " + contract_start_date + ", url = " + url + ", country = " + country + ", lat_ne = " + lat_ne + ", recruiter_locality = " + recruiter_locality + ", recruiter_postal_code = " + recruiter_postal_code + ", salary_range_begin = " + salary_range_begin + ", email = " + email + ", lat_sw = " + lat_sw + ", company = " + company + ", last_name = " + last_name + ", benefits = " + benefits + ", offer_administrative_area_level_1 = " + offer_administrative_area_level_1 + "]";
    }

    @Override
    public JobOffering toJobObject() {
       JobOffering offering = new JobOffering(id, getFirst_name());
        return offering;
    }
}
